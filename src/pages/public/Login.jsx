...
import { loginCompany, loginSchool,loginAdmin } from '../../api'
  ...
  const handleSubmit = async (ev) => {
    ...
    try {
      if (role === 'company') {
        ...
        // Save tokens and company info to localStorage
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex bg-gray-100 p-1 rounded-2xl mb-8">
            {tabs.map(({ key, label, icon: Icon }) => (
              <button key={key} onClick={() => { setRole(key); setServerError('') }}
